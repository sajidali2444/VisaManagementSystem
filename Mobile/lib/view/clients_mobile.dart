...
import 'create_clients_mobile.dart';

class Clients extends StatelessWidget {
  // List of clients using the model
            ...
            child: Container(
              ...
              child: ElevatedButton(
                onPressed: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => CreateClientsMobile()),
                  );
                },
                    ...
                    children: [
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            _buildDetailRow("Apply Date", client.applyDate),
                            _buildDetailRow("Type", client.type),
                            _buildDetailRow("Passport No", client.passportNo),
                            _buildDetailRow("Nationality", client.nationality),
  ...
  showDialog(
    ...
    builder: (BuildContext context) {
      return AlertDialog(
        ...
        content: const Text(
          'Are you sure that you want to delete this client permanently?',
