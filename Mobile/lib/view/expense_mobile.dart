import 'package:figma_design1/Model/expense_model.dart';
import 'package:figma_design1/view/sidebar_mobile.dart';
import 'package:flutter/material.dart';

import 'create_expense_mobile.dart';


class ExpenseMobile extends StatelessWidget {
  // List of expense using the model
  final List<ExpenseModel> expense = [
    ExpenseModel(name: "Goku Black"),
    ExpenseModel(name: "Goku Black"),
    ExpenseModel(name: "Goku Black"),
    ExpenseModel(name: "Goku Black"),
    ExpenseModel(name: "Goku Black"),
            ...
            child: Container(
              ...
              child: ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => CreateExpenseMobile()),
                  );
                  // Create new action
                },
  ...
  showDialog(
    ...
    builder: (BuildContext context) {
      return AlertDialog(
        ...
        content: const Text(
          'Are you sure that you want to delete this expense permanently?',
